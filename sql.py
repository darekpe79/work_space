...
conn = sqlite3.connect('databes3.sqlite')
cur = conn.cursor()
...
CREATE TABLE Book (
    ...
    id_rec TEXT,
    UNIQUE (book_name,book_isbn, author_id, publisher_id, id_rec)
...
plik=r"F:\Nowa_praca\fennica\MARK 10.03.2022Ujednolicone_OSOBY\calosc_fennica_dobre_995.mrk"
...
for rekord in tqdm(dictrec):
    ...
    for elem in list_authors:
        ...
        for pub in list_publisher:
            ...
            cur.execute('''INSERT OR IGNORE INTO Book (book_name, author_id, publisher_id, book_isbn, id_rec)
              VALUES ( ?,?,?,?,? )''', ( title,author_id, publisher_id, isbn, id_record ) )
