...
#ladowanie modelu już wytrenowanego do ewaluacji
model_dir = r"C:/Users/darek/Downloads/model_TRUEFALSE_31_12_24-20260127T153003Z-3-001/model_TRUEFALSE_31_12_24"

tokenizer = HerbertTokenizerFast.from_pretrained(model_dir)
def tokenize_and_encode(examples):
    return tokenizer(
        examples['combined_text'],
        padding='max_length',
