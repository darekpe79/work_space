...
dataframe_viafy_ujednolicone=pd.read_excel(r"C:\Users\darek\zagubiony_arto.xlsx", sheet_name=1) 
pole100_lista=dataframe_viafy_ujednolicone['100'].tolist()
...
path=r"C:\Users\darek\zagubiony_arto.mrk.mrk"
             ...
             for value in val2:
                 if 'viaf.org' in value:
                     ...
                     if value in dict_pole100_viaf:
                         ...
                         nazwa_i_data_ujednolicona=dict_pole100_viaf[value]
