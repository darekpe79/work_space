...
genre=pd.read_excel(R"D:\Nowa_praca\655_chapters_cz_do mrk.xlsx", sheet_name=1) 

genre_dict = dict(zip(genre['desk655'].tolist(),genre['major genre'].tolist()))
pattern3=r'(?<=\$a).*?(?=\$|$)' 



for plik in ["D:/Nowa_praca/marki_29_07_2022/cz_chapters.mrk"]:
            ...
            if key=='655':
                ...
                if literature_genre and secondary:
                    ...
                    if '380' in nowe:
                        ...
                        list_set=unique(secondary+[r'\\$iMajor genre$aLiterature$leng']+nowe['381'].split('❦'))
                    ...
                    if '380' in nowe:
                        ...
                        list_set=unique([r'\\$iMajor genre$aLiterature$leng']+nowe['381'].split('❦'))
                    ...
                    if '380' in nowe:
                        ...
                        list_set=unique(secondary+nowe['381'].split('❦'))
    ...
    to_file (path+'_'+str(date_object)+'.mrk', rekordy)  
