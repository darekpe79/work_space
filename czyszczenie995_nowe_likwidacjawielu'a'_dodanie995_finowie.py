...
plik=r"F:\Nowa_praca\pliki_nikodem_4.04.2022\wetransfer_pbl_bn_fin_04-04-2022_2022-04-04_1004\proba.mrk"
...
for listy in tqdm(dictrec):
    listy.setdefault('995', '\\\$aKansalliskirjasto')
    nowe={}
