# -*- coding: utf-8 -*-
"""
Created on Thu Jul  4 13:23:00 2024
    ...
    with open(file_path, 'rb') as fh:
        ...
        for record in tqdm(reader, desc="Processing MARC records", unit="record"):
            ...
            if title and author:
                ...
                question_form = random.choice(question_forms)  # Losowy wybór formy pytania
                synonym = random.choice(wrote_synonyms)  # Losowy wybór synonimu
...
training_args = TrainingArguments(
    ...
    save_strategy="epoch",
    learning_rate=1e-5,  # Mały learning rate
)
