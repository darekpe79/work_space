...
for plik in ["C:/Users/dariu/Desktop/praca/marki_29_07_2022/bn_chapters.mrk",
        ...
        #             del(nowe['381'])
             ...
             if key=='380':
                ...
                if literature_genre and secondary:
                    if '381' in nowe:
                        list_set=unique(literature_genre+[nowe['381']])
                    ...
                    if '380' in nowe:
                        ...
                        list_set=unique(secondary+[r'\\$iMajor genre$aLiterature$leng']+[nowe['380']])
                    ...
                    if '380' in nowe:
                        ...
                        list_set=unique([r'\\$iMajor genre$aLiterature$leng']+[nowe['380']])
                    ...
                    if '380' in nowe:
                        ...
                        list_set=unique(secondary+[nowe['380']])
