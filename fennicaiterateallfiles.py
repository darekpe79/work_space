...
directory=r'/home/darek/Nowa_praca /fennica/arto'
for filename in tqdm(os.listdir(r'/home/darek/Nowa_praca /fennica/arto')):
    if filename.endswith(".mrk"):
        plik=os.path.join(directory, filename)
        splitpath=plik.split('/')
        tosplit=splitpath[-1].split('.')
        tofile=tosplit[0]
        print(tofile)
        ...
        to_file(tofile+'odsiane.mrk',ostateczna_lista)
