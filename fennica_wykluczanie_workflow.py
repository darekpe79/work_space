...
#%%Sprawdzam czy mam jakies 810,  (zeby je wykluczyc przy wyszukiwaniu 81, jesli brak moge od razu wyszukac 81, jesli brak jade dalej. Wszystko to w rekordach bez YKL (tam 81 jest dobre i porządane) rekordy_bez_YKL to rekordy z dobrym YKL 
...
#%% zabawa z hasłami
hasla=pd.read_excel(r"F:\Nowa_praca\fennica\Hasła_po_selekcji_wszystkie.xlsx")
