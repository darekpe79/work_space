...
conn = sqlite3.connect('pbl.sqlite')
cur = conn.cursor()
...
plik=r"F:\Nowa_praca\libri\Iteracja 2021-07\16.03.2022 nowe MARC_poprawiony_ISSN\ujedn_PBL_books.mrk"
...
for rekord in tqdm(dictrec):
    ...
    for elem in list_authors:
        ...
        for pub in list_publisher:
            ...
            cur.execute('''INSERT OR IGNORE INTO Book_auth (book_id, author_id, publisher_id)
              VALUES ( ?,?,? )''', ( book_id, author_id, publisher_id ) )
