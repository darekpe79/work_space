...
file1.close()
#%% z zapisanych juz rekordow czytamy id number 
record8084_id=[]
for record in records8084:
    record8084_id.append(record['001'])
...
file1 = open("fennica650_ogolne.mrk", "w", encoding='utf-8') 
for record in records650:
...
#%% zapisanie do pliku mrk rekordow z listy records650                
file1 = open("fennica650only_LITERATURE.mrk", "w", encoding='utf-8') 
for record in kirjallisuus:
...
#%% zapisanie do pliku mrk rekordow z listy records650                
file1 = open("fennica650_tylko_szczegolowe.mrk", "w", encoding='utf-8') 
for record in records650haslaszczegol:
...
#%% zapisanie do pliku mrk rekordow z listy records650                
file1 = open("fennica_YSO87.mrk", "w", encoding='utf-8') 
for record in recordsYSO87:
